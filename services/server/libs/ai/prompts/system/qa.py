...
def _create_qa_system_prompt(template: str) -> ChatPromptTemplate:
    return ChatPromptTemplate.from_messages([
        SystemMessage(content=template)
    ] + _shared_messages)


EQE_QA_SYSTEM_PROMPT = _create_qa_system_prompt(_eqe_template)

EPAC_QA_SYSTEM_PROMPT = _create_qa_system_prompt(_epac_template)
